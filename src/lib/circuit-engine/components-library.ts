...
export const CIRCUIT_COMPONENTS_LIBRARY: CircuitComponentDef[] = [
  ...
  // =========================================================================
  {
    ...
    bodyColor: '#FBFBFA',
    accentColor: '#38BDF8',
    description: '400-Tie Point Half-Size Solderless Breadboard with Dual Power Rails & IC Channel',
    renderType: 'breadboard_400',
    pins: [
      { id: 'TOP_GND_L', name: 'Top - (GND)', type: 'ground', x: 20, y: 18, side: 'top', color: '#1F2937' },
      { id: 'TOP_GND_R', name: 'Top - (GND)', type: 'ground', x: 360, y: 18, side: 'top', color: '#1F2937' },
      { id: 'TOP_VCC_L', name: 'Top + (5V)', type: 'power-5v', x: 20, y: 38, side: 'top', color: '#EF4444' },
      { id: 'TOP_VCC_R', name: 'Top + (5V)', type: 'power-5v', x: 360, y: 38, side: 'top', color: '#EF4444' },
      { id: 'COL1_FJ', name: 'Col 1 (f-j)', type: 'digital', x: 18, y: 70, side: 'left', color: '#38BDF8' },
      { id: 'COL30_FJ', name: 'Col 30 (f-j)', type: 'digital', x: 362, y: 70, side: 'right', color: '#38BDF8' },
      { id: 'COL1_AE', name: 'Col 1 (a-e)', type: 'digital', x: 18, y: 138, side: 'left', color: '#38BDF8' },
      { id: 'COL30_AE', name: 'Col 30 (a-e)', type: 'digital', x: 362, y: 138, side: 'right', color: '#38BDF8' },
      { id: 'BOT_GND_L', name: 'Bot - (GND)', type: 'ground', x: 20, y: 172, side: 'bottom', color: '#1F2937' },
      { id: 'BOT_GND_R', name: 'Bot - (GND)', type: 'ground', x: 360, y: 172, side: 'bottom', color: '#1F2937' },
